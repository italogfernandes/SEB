...
void loop() {
  ...
  //Regra de 3 para conversao de escala
  //Subtrai o offset e divide pelo tamanho total
  //Multiplica por 100 para dar em porcentagem
  ...
  for (int i = 0; i < 4; i++) { //Acendendo os leds proporcionalmente
    //Para cada led (de 0 a 4)
    //Coloca ele de acordo com a expressao
    //porcentagem > 20 * (i+1)
    //ou seja 20 * 1 = 20
    // 20 * 2 = 40 .... ate 20 * 4 = 80
    // se a expressao retornar True (1, HIGH) acende
    // se a expressao retornar False (0, LOW) apaga
