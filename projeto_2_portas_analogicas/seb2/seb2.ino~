/* UNIVERSIDADE FEDERAL DE UBERLANDIA
   ...
   O que faz:
      Realiza leitura de 1 potenciometro, acende alguns leds e envia para serial.
   TODO:
   ...
   Pacotes:
   Leitura do Potenciometro - Chave Fechada: (4 bytes)
   ['$'] [MSB] [LSB] ['\n']
   Leitura do Potenciometro - Chave Aberta: (4 bytes)
   ['$'] [MSB] [LSB] ['\r']
    Esquema de montagem:
    Arduino - Dispositivo
    3.3V	- Potenciometro - Pino 1
    A0      - Potenciometro - Pino 2
    GND     - Potenciometro - Pino 3
